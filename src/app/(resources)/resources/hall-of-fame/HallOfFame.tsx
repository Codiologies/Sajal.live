  ...
  const companies: Company[] = [
    {
      ...
      description: 'HDFC Bank recognized for responsible disclosure and collaboration.'
    },
    {
      id: 'rapyd',
      name: 'Rapyd',
      logo: '/logos/hof/rapyd.png',
      category: 'financial',
      tier: 'gold',
      year: 2025,
      vulnerabilities: 1,
      ...
      featured: true,
      tags: ['Security Research'],
      description: 'Rapyd recognized for contributions to security and bug bounty programs.'
    },
    {
      id: 'tesla',
      name: 'Tesla',
      logo: '/logos/hof/tesla.png',
      category: 'tech',
      tier: 'platinum',
      year: 2024,
      vulnerabilities: 1,
      ...
      featured: true,
      tags: ['Security Research'],
      description: 'Tesla recognized for commitment to security and responsible disclosure.'
    },
    {
      id: 'trip-advisor',
      name: 'Trip Advisor',
      logo: '/logos/hof/tripadvisor.png',
      category: 'tech',
      tier: 'gold',
      year: 2024,
      vulnerabilities: 1,
      ...
      featured: true,
      tags: ['Security Research'],
      description: 'Trip Advisor recognized for supporting security researchers.'
    },
    {
      id: 'lpu',
      name: 'Lovely Professional University',
      logo: '/logos/hof/lpu.png',
      category: 'other',
      tier: 'silver',
      year: 2024,
      vulnerabilities: 1,
              ...
              >
                <div className="h-full p-6 rounded-2xl border border-zinc-800/30 backdrop-blur-sm hover:border-zinc-700/50 transition-all duration-300 flex flex-col justify-between"
                  ...
                  <div className="flex justify-between items-start mb-4 relative z-10">
                    <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-zinc-800 overflow-hidden">
                      {company.logo ? (
                        <Image
                          src={company.logo}
                          alt={company.name}
