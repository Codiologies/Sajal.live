...
const AboutPage = () => {
  ...
  const personalInterests = [
    ...
    },
    {
      icon: BookOpen,
      title: "Reading Books",
      description: "Passionate about reading thought-provoking books like 'Zero to One' that inspire innovation and strategic thinking. Books help me gain diverse perspectives and stay mentally sharp.",
            ...
            <motion.div variants={fadeInUp}>
              <LiquidGlass variant="clean" intensity="high" rounded="2xl" className="p-8 md:p-12">
                <div className="space-y-6 text-zinc-300 text-lg leading-relaxed">
                  ...
                  <p>
                    I hold industry-recognized certifications including eJPT (eLearnSecurity Junior Penetration Tester) and eWPT (eLearnSecurity Web Application Penetration Tester), which validate my expertise in penetration testing and web security assessment. These certifications have provided me with practical, real-world knowledge in identifying and exploiting vulnerabilities.
                  </p>
                  <p>
                    I have a strong passion for learning and sharing knowledge with the cybersecurity community. I actively participate in bug bounty programs, capture-the-flag (CTF) challenges, and open-source security projects to enhance my skills and contribute to the broader security ecosystem.
                  </p>
                  <p>
                    Beyond my professional pursuits, I am passionate about exploring new technologies, solving complex security puzzles, and contributing to open-source projects. I believe in a balanced approach to life and make time for travel, photography, and music - hobbies that help me maintain creativity and perspective in my work.
                  </p>
                </div>
