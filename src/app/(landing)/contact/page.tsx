                    ...
                    <div className="px-6 sm:px-8 py-6 border-b border-zinc-700/30 bg-gradient-to-r from-zinc-900/50 to-zinc-800/30">
                      <div className="flex items-center justify-between">
                        ...
                        <motion.div
                          ...
                          className="text-xs px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/10 to-blue-500/10 text-purple-300 border border-purple-500/20 flex items-center gap-1"
                        >
