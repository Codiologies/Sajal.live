...
const skillTypes = [
  ...
  },
  {
    ...
    description: "Bug bounty hunter with proven track record",
    color: "green",
          ...
          <div className="relative z-10 flex flex-col justify-center pt-8 sm:pt-0">
            ...
            >
              ...
              <p className="mt-2 sm:mt-4 text-zinc-400 max-w-lg text-sm sm:text-base">
                Bug bounty hunter and security researcher with expertise 
              ...
              <div className="mt-6 sm:mt-10 space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-3 sm:space-x-4 group">
                  ...
                  <div className="text-zinc-300 text-xs sm:text-sm md:text-base group-hover:text-blue-400 transition-colors duration-300">5+ Hall of Fame recognitions</div>
                </div>
                <div className="flex items-center space-x-3 sm:space-x-4 group">
                ...
                <div className="flex items-center space-x-3 sm:space-x-4 group">
                  ...
                  <div className="text-zinc-300 text-xs sm:text-sm md:text-base group-hover:text-purple-400 transition-colors duration-300">10+ Security projects completed</div>
                </div>
              </div>
            </motion.div>
          </div>
