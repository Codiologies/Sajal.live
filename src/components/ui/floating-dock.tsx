...
export const FloatingDock = ({
  ...
  const dockItems = [
    ...
    { title: "LinkedIn", icon: <IconBrandLinkedin size={18} />, href: "https://www.linkedin.com/in/sajalgupta2812/" },
    { title: "X", icon: <IconBrandX size={18} />, href: "https://twitter.com/codiologies" },
